...
class PersonArray_t
{
	public:
		...
		explicit PersonArray_t(size_t capacity);  //explicit keyword in order to prevent PersonArray_t a = 2 for instance.
	...
	private:
		...
		void shift_left(size_t index); // will shift all the items to the left form index towarads num_of_elements.
